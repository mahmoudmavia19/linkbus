...
class IntroScreenOnboardingPlus extends StatefulWidget {
  final List<IntroductionPlus>? introductionList;
...
class _IntroScreenOnboardingState extends State<IntroScreenOnboardingPlus> {
